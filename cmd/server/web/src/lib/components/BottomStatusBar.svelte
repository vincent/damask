...
<div
  class="absolute right-0 bottom-0 left-0 z-10 flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 opacity-[92%] dark:border-gray-800 dark:bg-gray-900"
>
  {#if $gModeActive}
    <div
  ...
  {#if s.showZoom}
    <div
      class="text-md mr-5 ml-auto flex items-center gap-2 text-gray-500 dark:text-gray-400"
    >
      <ZoomOut
  ...
  <div class="flex items-center gap-3">
    ...
    <div class="relative">
      ...
      {#if langOpen}
        <div
          class="absolute right-0 bottom-full mb-1 overflow-hidden rounded border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800"
        >
          {#each locales as locale}
            <button
              ...
              class="block w-full px-3 py-1.5 text-left text-xs hover:bg-gray-100 dark:hover:bg-gray-700 {locale ===
              currentLocale
