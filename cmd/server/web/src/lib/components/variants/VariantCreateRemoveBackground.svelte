...
<div class="space-y-5">
  <div
    class="text-md rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-amber-800 dark:border-amber-800 dark:bg-amber-900/20 dark:text-amber-300"
  >
    <p class="mb-1 font-medium">Requires Remove.bg API key</p>
    <p class="text-sm">
      Set <code class="rounded bg-amber-100 px-1 dark:bg-amber-800/50"
        >REMOVEBG_API_KEY</code
      > in your server environment. Returns a transparent PNG.
    </p>
  </div>
