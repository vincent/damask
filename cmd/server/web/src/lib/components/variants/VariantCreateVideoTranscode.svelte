...
<div class="space-y-6">
    <div class="space-y-4 rounded-xl border border-gray-200 p-4 dark:border-gray-700">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">Heavy operation. Requires ffmpeg.</p>
        ...
        <div>
        <label for="variant-{kind}-resolution" class="mb-1 block text-sm font-medium text-gray-600 dark:text-gray-400">Resolution <span class="text-gray-400">(optional)</span></label>
