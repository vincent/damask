<script lang="ts">
  ...
  $effect(() => {
    ...
    if (!currentWatermark || !asset.width || !asset.height) return
    ...
    image.onload = () => {
      ...
      watermarkTileWidth = (image.naturalWidth / asset.width) * 100
      watermarkTileHeight = (image.naturalHeight / asset.height) * 100
    }
  })
</script>
