<script lang="ts">
  import { versionApi, formatBytes, type Asset, type AssetVersion } from '$lib/api'
  ...
  {:else}
    <ol class="relative mx-5 mt-4 mb-2 border-l border-gray-200 dark:border-gray-700">
      {#each versions as v (v.id)}
        <li class="mb-6 ml-4">
          <!-- Timeline dot -->
          <div class="absolute -left-1.5 mt-1.5 h-3 w-3 rounded-full border-2 border-white bg-gray-300 dark:border-gray-900 dark:bg-gray-600
          ...
          <div class="rounded-xl border border-gray-100 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between gap-2">
              ...
              <!-- Timestamp -->
              <span class="shrink-0 flex items-center gap-1 text-[11px] text-gray-400 dark:text-gray-500">
                <Clock class="h-3 w-3" />
